...
import com.example.android.myapplication.api.ApiResponse;
...
import com.example.android.myapplication.model.Uvi;
import com.example.android.myapplication.model.UviDb;
import com.example.android.myapplication.model.WeatherForecast;
...
public class ForecastRepository {
    ...
    @Inject
    ForecastRepository(AppExecutors appExecutors,
...
//                return weatherService.getWeatherForecast(city, numDays, Constants.UNIT_SYSTEM, BuildConfig.WEATHER_API_KEY);
           return weatherService.getWeatherForecast(city,numDays, Constants.UNIT_SYSTEM, BuildConfig.APPLICATION_ID);
            }
...
//                return weatherService.getUvi(lat, lon, BuildConfig.apiKey);
                return weatherService.getUvi(lat,lon,BuildConfig.APPLICATION_ID);
            }
